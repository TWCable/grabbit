...
* __deleteBeforeWrite__: boolean. Before the client retrieves content, should content under each path be cleared?  When used in combination with _excludePaths_, nodes indicated by _excludePaths_ will not be deleted 
